...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'Brazo11(WebGL).data';
    var REMOTE_PACKAGE_BASE = 'Brazo11(WebGL).data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 37740988;
      var PACKAGE_UUID = '80edae2d-4045-4406-9beb-097643a5d6ac';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 34689757, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(34689757, 34689778, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(34689778, 36218062, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(36218062, 37713362, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(37713362, 37740988, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_Brazo11(WebGL).data');

    };
    Module['addRunDependency']('datafile_Brazo11(WebGL).data');
